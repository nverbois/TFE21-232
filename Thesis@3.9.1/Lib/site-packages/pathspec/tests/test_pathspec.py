...
class PathSpecTest(unittest.TestCase):
    ...
    def test_01_current_dir_paths(self):
		...
		"""
        spec = pathspec.PathSpec.from_lines("gitwildmatch", ["*.txt", "!test1/",])
        results = set(
            spec.match_files(
                [
                    "./src/test1/a.txt",
        ...
        self.assertEqual(
            results, {"./src/test2/a.txt", "./src/test2/b.txt", "./src/test2/c/c.txt",}
        )
    ...
    def test_01_windows_paths(self):
        ...
        self.assertEqual(
            results, {"src\\test2\\a.txt", "src\\test2\\b.txt", "src\\test2\\c\\c.txt",}
        )
    ...
    def test_02_eq(self):
		...
		Tests equality.
		"""
        first_spec = pathspec.PathSpec.from_lines("gitwildmatch", ["*.txt", "!test1/",])
