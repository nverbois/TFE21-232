...
class GeneratorNonlocalControl(BaseNonlocalControl):
    ...
    def gen_return(self, builder: "IRBuilder", value: Value, line: int) -> None:
        ...
        builder.assign(
            builder.fn_info.generator_class.next_label_target,
...
class ExceptNonlocalControl(CleanupNonlocalControl):
    ...
    def __init__(
        self, outer: NonlocalControl, saved: Union[Value, AssignmentTarget]
    ) -> None:
...
class FinallyNonlocalControl(CleanupNonlocalControl):
    ...
    def __init__(
        self, outer: NonlocalControl, ret_reg: Optional[Value], saved: Value
    ) -> None:
        super().__init__(outer)
