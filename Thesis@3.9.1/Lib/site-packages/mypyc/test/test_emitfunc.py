...
class TestFunctionEmitterVisitor(unittest.TestCase):
    ...
    def test_int_neg(self) -> None:
        self.assert_emit(
            PrimitiveOp([self.m], int_neg_op, 55),
            "cpy_r_r0 = CPyTagged_Negate(cpy_r_m);",
        )

    def test_list_len(self) -> None:
        self.assert_emit(
            PrimitiveOp([self.l], list_len_op, 55),
            """Py_ssize_t __tmp1;
    ...
    def test_list_get_item(self) -> None:
        self.assert_emit(
            PrimitiveOp([self.m, self.k], list_get_item_op, 55),
    ...
    def test_dict_get_item(self) -> None:
        self.assert_emit(
            PrimitiveOp([self.d, self.o2], dict_get_item_op, 1),
    ...
    def test_new_dict(self) -> None:
        self.assert_emit(
            PrimitiveOp([], new_dict_op, 1), """cpy_r_r0 = PyDict_New();"""
        )
