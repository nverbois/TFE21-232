...
class DateTimeRange(object):
    ...
    def set_start_datetime(
        self, value: Union[datetime.datetime, str], timezone: Optional[str] = ...
    ) -> None: ...
    def set_end_datetime(
        self, value: Union[datetime.datetime, str], timezone: Optional[str] = ...
    ) -> None: ...
    def set_time_range(
        self, start: Union[datetime.datetime, str], end: Union[datetime.datetime, str]
    ) -> None: ...
    def range(
        self, step: Union[datetime.timedelta, relativedelta]
