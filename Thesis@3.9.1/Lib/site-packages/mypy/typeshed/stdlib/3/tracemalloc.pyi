...
class Snapshot:
    def __init__(
        self, traces: Tuple[Tuple[str, int], ...], traceback_limit: int
    ) -> None: ...
    def compare_to(
...
class Trace:
    ...
    if sys.version_info >= (3, 9):
        def __init__(
            self,
            trace: Union[
                Tuple[int, int, Tuple[Tuple[str, int], ...], Optional[int]],
                Tuple[int, int, Tuple[Tuple[str, int], ...]],
            ],
        ) -> None: ...
    else:
        def __init__(
            self, trace: Tuple[int, int, Tuple[Tuple[str, int], ...]]
        ) -> None: ...
...
class Traceback(Sequence[Frame]):
    if sys.version_info >= (3, 9):
        ...
        def __init__(
            self, frames: Tuple[Tuple[str, int], ...], total_nframe: Optional[int] = ...
        ) -> None: ...
    else:
