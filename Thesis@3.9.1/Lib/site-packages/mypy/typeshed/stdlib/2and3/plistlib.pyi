...
if sys.version_info >= (3, 9):
    ...
    @overload
    def load(
        fp: IO[bytes], *, fmt: Optional[PlistFormat] = ..., dict_type: Type[_D]
    ) -> _D: ...
    @overload
    def loads(value: bytes, *, fmt: Optional[PlistFormat] = ...) -> DictT[str, Any]: ...
    @overload
    def loads(
        value: bytes, *, fmt: Optional[PlistFormat] = ..., dict_type: Type[_D]
    ) -> _D: ...
    ...
    @overload
    def loads(
        value: bytes, *, fmt: Optional[PlistFormat] = ..., use_builtin_types: bool = ...
    ) -> DictT[str, Any]: ...
    @overload
    def loads(
        value: bytes,
