...
def load_graph(
    ...
    for bs in sources:
        ...
        if st.id in graph:
            ...
            if p1 != p2:
                manager.errors.report(-1, -1, "Are you missing an __init__.py?")
                ...
                try:
                    ...
                    if newst.path in seen_files:
                        manager.errors.report(
                            -1,
                            0,
                            "Source file found twice under different module names: '{}' and '{}'".format(
                                seen_files[newst.path].id, newst.id
                            ),
                            blocker=True,
                        )
                        manager.errors.raise_error()
